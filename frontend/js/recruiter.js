...
//               ${c.resume ? `<a href="${c.resume}" target="_blank" class="btn btn-primary btn-sm w-full" style="justify-content:center">📄 Download Resume</a>` : `<div class="text-muted">No resume uploaded</div>`}
//             </div>
//           </div>
